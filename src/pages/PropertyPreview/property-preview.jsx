...
export default function PreopertyPreview(){
    ...
    const incrementCurrImageIndex = () => {
        changeCurrImageIndex(prev => {
    ...
    const splitStringIntoParagraphs = (text, maxLength) => {
        ...
        //     paragraphs.push(text.slice(i, i + maxLength))
        // }
        let start = 0
        while(start < text.length){
            ...
            paragraphs.push(text.slice(start, end + 1));
            start = end + 1;
        }
        return paragraphs
    }
                        ...
                        <div className="img-section"> 
                            <div className="img-area">
                                <div className="img-area-center">
                                    <img src={`${data?.Images[currImageIndex] ?? CameraSVG}`} className="p-image"></img>
                                    {/* <button className="add-photos-btn">
                                        <img src={PlusSVG}></img>
                                        Add Photos Now
                                    </button> */}
                                </div>
                                <img src={LeftArrow} className="left-arrow" onClick={decrementCurrImageIndex}/>
                                <img src={RightArrow} className="right-arrow" onClick={incrementCurrImageIndex}/>
                            </div>
